...
$('.tool .fui-chat').click(function (){
    var items = ['其实，iris并不像你这样累','感觉不如去qq里说话...','你好呀！','在这里的只是我的投影罢了（笑）','我好快乐，因为我是iris！','(    = w =  )','人类为什么对随机这么着迷呢？','可以去听听《我们的田野》','人类的爱是什么东西呢？','您太重了！','你情就是命令，防你就是责任！','笑了，找iris真身找到这来了','模型可能会崩坏。别被吓到（笑）','你可能注意到视线跟踪有一些漂移...容忍下这些bug吧，毕竟作者不会写网页...','你可能注意到视线跟踪有一些漂移...容忍下这些bug吧，毕竟作者不会写网页...','假如我可以得知你在想些什么，那么我将尝试减轻你的痛苦','太阳，我在这里！','太阳，你在哪里？','iris是谁？你？','摸了','在无意义的事情上浪费时间...','你知道吗：其实我是qq机器人','还是要多注意休息','诶？','在呢','iris现在是清醒状态（笑）'];
...
(function (){
    ...
    if (window.location.href == SiteIndexUrl) {      // 如果是主页
        ...
        if (now > 23 || now <= 5) {
            text = 'iris现在是清醒状态...但是这个时间对于人类来说还是太晚了';
        } else if (now > 5 && now <= 7) {
